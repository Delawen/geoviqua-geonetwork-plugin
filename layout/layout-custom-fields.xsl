...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Readonly elements -->
  <xsl:template mode="mode-iso19139.geoviqua" priority="2000" match="gmd:fileIdentifier|gmd:dateStamp">
  ...
  -->
  <xsl:template mode="mode-iso19139.geoviqua" priority="100" match="gmd:topicCategory">
    ...
    <xsl:call-template name="render-element">
      ...
      <xsl:with-param name="type" select="gn-fn-iso19139.geoviqua:getCodeListType(name())"/>
      <xsl:with-param name="editInfo" select="*/gn:element"/>
  ...
  -->
  <xsl:template mode="mode-iso19139.geoviqua" match="gts:TM_PeriodDuration|gml:duration" priority="200">
  ...
  <xsl:template mode="mode-iso19139.geoviqua" match="gml:beginPosition|gml:endPosition|gml:timePosition"
    priority="200">
  ...
  <xsl:template mode="mode-iso19139.geoviqua" match="gmd:EX_GeographicBoundingBox" priority="2000">
