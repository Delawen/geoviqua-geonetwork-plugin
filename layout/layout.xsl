...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template mode="mode-iso19139.geoviqua" match="gn:*|@gn:*|@*" priority="1000"/>
  ...
  <xsl:template mode="mode-iso19139.geoviqua" match="gn:child" priority="2000">
  ...
  <xsl:template mode="mode-iso19139.geoviqua" match="gmd:*|gmx:*|gml:*|srv:*|gts:*">
    <xsl:param name="schema" select="$schema" required="no"/>
    <xsl:param name="labels" select="$labels" required="no"/>
  ...
  -->
  <xsl:template mode="mode-iso19139.geoviqua" priority="200"
