...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template mode="mode-iso19139.geoviqua" priority="2000" match="
    ...
    <xsl:call-template name="render-boxed-element">
      ...
      <xsl:with-param name="subTreeSnippet">
        <xsl:apply-templates mode="mode-iso19139.geoviqua" select="*">
  ...
  <xsl:template mode="mode-iso19139.geoviqua" match="gmd:MD_Keywords" priority="2000">
    ...
    <xsl:choose>
      <xsl:when test="$isTheaurusAvailable">
        ...
        <xsl:variable name="transformations">to-iso19139.geoviqua-keyword,to-iso19139.geoviqua-keyword-with-anchor,to-iso19139.geoviqua-keyword-as-xlink</xsl:variable>

        <!-- Get current transformation mode based on XML fragement analysis -->
        <xsl:variable name="transformation"
          select="if (count(gmd:keyword/gmx:Anchor) > 0) 
          then 'to-iso19139.geoviqua-keyword-with-anchor' 
          else if (@xlink:href) then 'to-iso19139.geoviqua-keyword-as-xlink' 
          else 'to-iso19139.geoviqua-keyword'"/>
