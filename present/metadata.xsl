  ...
  <!-- gmx:FileName could be used as substitution of any
			...
			<td valign="middle" colspan="2">
				<xsl:if test="$currTab='metadata' or $currTab='identification' or /root/gui/config/metadata-tab/*[name(.)=$currTab]/@flat">
					<div style="float:left;width:70%;">
						<!-- geolabel -->
						<div id="xhr_geolabel" style="position: relative; float: left; text-align: center; margin: 0 20px; width: 150px; height: 150px;">
	...
	<xsl:template name="iso19139.gvq-javascript">
		...
		var xhr = createCORSRequest('POST', 'http://tutorial.geoviqua.org/geolabel.php'),
			...
			container = document.getElementById('xhr_geolabel');
